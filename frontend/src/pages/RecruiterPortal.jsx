                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px' }}>
                          ...
                          <div>
                            <div style={{ marginBottom: '32px' }}>
                              <h2 style={{ fontSize: '1.8rem', fontWeight: 900, marginBottom: '8px', color: 'var(--primary)' }}>Resume Extraction Intelligence</h2>
                              <p className="label" style={{ fontSize: '0.65rem', opacity: 0.6 }}>Automated Technical Evidence Synthesis</p>
                            </div>
